...
plt.plot(time_1, n_unoccupied_1, marker='', linestyle='-', color='b', label="Test for PR=0.1 (status-quo)")

# Plot the data from the second file
plt.plot(time_2, n_unoccupied_2, marker='', linestyle='--', color='r', label="Test for PR=0.05 (status-quo-2)")

# Plot the data from the third file
plt.plot(time_3, n_unoccupied_3, marker='', linestyle='-', color='y', label="Test for PR=1 (status-quo-3)")
